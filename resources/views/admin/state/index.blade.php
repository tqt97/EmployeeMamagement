...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">State management</h1>
        <a href="{{ route('states.create') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                        ...
                        @forelse ($states as $state)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form id="delete-form" action="{{ route('states.destroy', $state->id) }}" method="POST"
                                        class="d-none">
                                        @csrf
                                        @method('DELETE')
                                    </form>
